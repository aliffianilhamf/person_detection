...
if __name__ == '__main__':
    ...
    print("Target Image Path:", args.target)
    print("Query Image Path:", args.query)
    ...
    print(f"Number of faces detected in target image: {faces1.shape[0]}")
    print(f"Number of faces detected in query image: {faces2.shape[0]}")
